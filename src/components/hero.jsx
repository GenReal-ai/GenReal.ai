...
const ColorfulPillNavbar = ({ activeSection, onMobileMenuToggle }) => {
  ...
  return (
    <>
      ...
      >
        {/* MODIFIED: Removed backdrop-blur, border, and shadow classes */}
        <div className="flex items-center rounded-full px-4 py-3">
      ...
      <div className={`md:hidden fixed top-6 left-6 right-6 z-50 flex justify-between items-center transition-all duration-300 ${
        ...
        <button
          ...
          className="flex items-center justify-center w-12 h-12 rounded-full transition-all duration-300 hover:bg-white/5"
        >
