...
const AboutUsSection = () => {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // Plagiarism Code Block Animation
  ...
  return (
    <div ref={sectionRef} className="bg-gradient-to-b from-black via-slate-900 to-slate-950 text-white font-sans relative overflow-hidden" id="about">
      ...
      {/* Hero Section */}
      <section ref={heroRef} className="min-h-screen flex items-center justify-center relative z-10 py-8 px-4 sm:py-10 md:py-12 opacity-0">
        <div className="absolute inset-0 bg-gradient-to-br from-[#00D1FF]/2 via-transparent to-[#1E40AF]/2"></div>
        <div className="container mx-auto max-w-6xl relative z-20 px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
            <div className="space-y-3 sm:space-y-4 text-center lg:text-left">
              <h1 className="hero-title text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-extrabold mb-3 sm:mb-4 bg-gradient-to-r from-white via-cyan-400 to-white bg-clip-text text-transparent leading-tight">
                Defending Truth in the Digital Age
              </h1>
              <div className="hero-description space-y-2 sm:space-y-3">
                <p className="text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed text-[#E6F3FF] font-medium max-w-2xl mx-auto lg:mx-0">
              ...
              <div className="flex flex-wrap gap-2 sm:gap-3 mt-4 sm:mt-6 justify-center lg:justify-start">
                ...
                <a href="#Products">
                <button 
                  className="bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-semibold py-2.5 px-5 sm:py-3 sm:px-6 md:px-7 rounded-full shadow-lg hover:from-cyan-600 hover:to-blue-700 transform hover:scale-105 transition-all duration-300 text-sm sm:text-base"
                >
                  Start Detection
                </button>
                </a>
                {/* Secondary Button */}
                <button 
                  className="bg-cyan-600/20 border-2 border-cyan-400 text-cyan-400 font-semibold py-2.5 px-5 sm:py-3 sm:px-6 md:px-7 rounded-full shadow-sm hover:bg-cyan-500/20 hover:shadow-md transform hover:scale-105 transition-all duration-300 text-sm sm:text-base"
                >
                  View Demo
                </button>
              </div>
            ...
            <div className="relative flex justify-center lg:justify-end mt-6 lg:mt-0">
              <div className="relative w-full max-w-xs sm:max-w-sm h-56 sm:h-64 md:h-80 lg:h-96 bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl overflow-hidden border-2 border-cyan-400/50 shadow-2xl shadow-cyan-500/20">
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-3 sm:p-4 md:p-6">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-16 md:h-16 mb-2 sm:mb-3 bg-gradient-to-r from-[#00D1FF] to-[#0099CC] rounded-full flex items-center justify-center">
                    <svg className="w-5 h-5 sm:w-6 sm:h-6 md:w-8 md:h-8 text-black" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M12 2L2 7v10c0 5.55 3.84 9.74 9 10.95C16.16 26.74 22 22.55 22 17V7l-10-5z"/>
                    </svg>
                  </div>
                  <h3 className="text-base sm:text-lg md:text-xl font-bold text-white mb-1 sm:mb-2">AI Detection Engine</h3>
                  <p className="text-xs sm:text-sm md:text-base text-gray-400 mb-3 sm:mb-4">Upload any content and get instant authenticity verification powered by advanced neural networks.</p>
      ...
      <section ref={deepfakeRef} className="min-h-screen flex items-center py-8 sm:py-10 md:py-12 relative z-10 px-4">
        <div className="absolute inset-0 bg-gradient-to-br from-gray-900/50 to-slate-950/50"></div>
        <div ref={leftMotionRef} className="absolute left-4 sm:left-6 top-1/2 w-4 h-4 sm:w-6 sm:h-6 bg-[#00D1FF] rounded-full opacity-60 shadow-lg shadow-[#00D1FF]/50 z-20"></div>
        <div className="content-wrapper max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center z-10">
          <div className="text-center md:text-left">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-extrabold mb-3 sm:mb-4 md:mb-6 bg-gradient-to-r from-white via-[#00D1FF] to-white bg-clip-text text-transparent leading-tight">
              Deepfake Detection
            </h2>
            <div className="space-y-2 sm:space-y-3">
              <p className="text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed text-[#E6F3FF] font-medium max-w-xl mx-auto md:mx-0">
            ...
            <div className="space-y-2 sm:space-y-3 mb-4 sm:mb-6 mt-4 sm:mt-6 inline-block text-left">
              <div className="flex items-center gap-2 sm:gap-3">
                <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-[#00D1FF] rounded-full"></div>
                <span className="text-[#E6F3FF] text-xs sm:text-sm md:text-base font-medium">Real-time video and audio analysis</span>
              </div>
              <div className="flex items-center gap-2 sm:gap-3">
                <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-[#00D1FF] rounded-full"></div>
                <span className="text-[#E6F3FF] text-xs sm:text-sm md:text-base font-medium">Detection of latest deepfake techniques</span>
              </div>
              <div className="flex items-center gap-2 sm:gap-3">
                <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-[#00D1FF] rounded-full"></div>
                <span className="text-[#E6F3FF] text-xs sm:text-sm md:text-base font-medium">Comprehensive confidence scoring</span>
              </div>
            </div>
            <div className="flex flex-wrap gap-2 justify-center md:justify-start">
              <span className="bg-gradient-to-r from-[#00D1FF]/20 to-[#00D1FF]/10 px-3 py-1.5 sm:px-4 sm:py-2 rounded-full border border-[#00D1FF]/30 text-[#00D1FF] font-bold text-xs sm:text-sm">
                Real-time API
              </span>
            </div>
          </div>
          <div className="relative flex justify-center items-center mt-6 md:mt-0">
            <div className="w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg mx-auto relative" ref={deepfakeProgressRef}>
              <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl p-4 sm:p-5 md:p-6 border-2 border-cyan-400/50 shadow-2xl shadow-cyan-500/20">
                <h3 className="text-base sm:text-lg md:text-xl font-bold text-white mb-4 sm:mb-5 md:mb-6 text-center">Deepfake Analysis</h3>
                
                <div className="mb-3 sm:mb-4">
                  <div className="flex justify-between items-center mb-1.5 sm:mb-2">
                    <span className="status-text text-xs sm:text-sm md:text-base text-gray-400 opacity-50">Processing Video...</span>
                    <span className="percentage-text text-xs sm:text-sm md:text-base text-[#00D1FF] font-bold">0%</span>
                  </div>
                  <div className="w-full bg-gray-700 rounded-full h-1.5 sm:h-2">
                    <div className="progress-bar bg-gradient-to-r from-[#00D1FF] to-[#0099CC] h-1.5 sm:h-2 rounded-full" style={{width: '0%'}}></div>
                  </div>
                </div>

                <div className="mb-3 sm:mb-4">
                  <div className="flex justify-between items-center mb-1.5 sm:mb-2">
                    <span className="status-text text-xs sm:text-sm md:text-base text-gray-400 opacity-50">Face Detection...</span>
                    <span className="percentage-text text-xs sm:text-sm md:text-base text-[#00D1FF] font-bold">0%</span>
                  </div>
                  <div className="w-full bg-gray-700 rounded-full h-1.5 sm:h-2">
                    <div className="progress-bar bg-gradient-to-r from-[#00D1FF] to-[#0099CC] h-1.5 sm:h-2 rounded-full" style={{width: '0%'}}></div>
                ...
                <div className="mb-4 sm:mb-5 md:mb-6">
                  <div className="flex justify-between items-center mb-1.5 sm:mb-2">
                    <span className="status-text text-xs sm:text-sm md:text-base text-gray-400 opacity-50">AI Analysis...</span>
                    <span className="percentage-text text-xs sm:text-sm md:text-base text-[#00D1FF] font-bold">0%</span>
                  </div>
                  <div className="w-full bg-gray-700 rounded-full h-1.5 sm:h-2">
                    <div className="progress-bar bg-gradient-to-r from-[#00D1FF] to-[#0099CC] h-1.5 sm:h-2 rounded-full" style={{width: '0%'}}></div>
                ...
                <div className="final-result text-center opacity-0 scale-0">
                  <div className="bg-red-500/20 border border-red-500 rounded-lg p-3 sm:p-4">
                    <h4 className="text-red-400 font-bold text-base sm:text-lg md:text-xl mb-1 sm:mb-2">DEEPFAKE DETECTED</h4>
                    <p className="text-white text-xs sm:text-sm md:text-base">87% confidence - Synthetic content identified</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section ref={plagiarismRef} className="min-h-screen flex items-center py-8 sm:py-10 md:py-12 relative z-10 px-4">
        ...
        <div className="content-wrapper max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center z-10">
          <div className="text-center md:text-left">
            ...
            <div className="space-y-2 sm:space-y-3 mb-4 sm:mb-6 mt-4 sm:mt-6 inline-block text-left">
              <div className="flex items-center gap-2 sm:gap-3">
                <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-[#00D1FF] rounded-full"></div>
                <span className="text-[#E6F3FF] text-xs sm:text-sm md:text-base font-medium">Multi-language support (7+ languages)</span>
              </div>
              <div className="flex items-center gap-2 sm:gap-3">
                <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-[#00D1FF] rounded-full"></div>
                <span className="text-[#E6F3FF] text-xs sm:text-sm md:text-base font-medium">Semantic similarity detection</span>
              </div>
              <div className="flex items-center gap-2 sm:gap-3">
                <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-[#00D1FF] rounded-full"></div>
                <span className="text-[#E6F3FF] text-xs sm:text-sm md:text-base font-medium">Repository-wide scanning</span>
              </div>
            </div>
            <div className="flex flex-wrap gap-1.5 sm:gap-2 justify-center md:justify-start">
              <span className="bg-gradient-to-l from-[#00D1FF]/20 to-[#00D1FF]/10 px-2.5 py-1 sm:px-3 sm:py-1.5 md:py-2 rounded-full border border-[#00D1FF]/30 text-[#00D1FF] font-bold text-xs sm:text-sm">
                GitHub Integration
              </span>
              <span className="bg-gradient-to-l from-[#00D1FF]/20 to-[#00D1FF]/10 px-2.5 py-1 sm:px-3 sm:py-1.5 md:py-2 rounded-full border border-[#00D1FF]/30 text-[#00D1FF] font-bold text-xs sm:text-sm">
                IDE Plugins
          ...
          <div className="relative flex justify-center mt-6 md:mt-0">
            <div className="w-full max-w-xs sm:max-w-sm md:max-w-md h-40 sm:h-48 md:h-56 lg:h-64 mx-auto relative bg-gray-900 rounded-lg border border-[#00D1FF]/30 overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-br from-[#00D1FF]/5 to-transparent"></div>
              <div ref={codeBlockRef} className="p-2 sm:p-3 md:p-4 font-mono text-xs sm:text-sm leading-relaxed">
                ...
                <div className="code-line text-white ml-2 sm:ml-4">return a + b;</div>
                <div className="code-line text-blue-400">{'}'}</div>
                <div className="code-line text-gray-500 mt-1 sm:mt-2">// Detected Plagiarism</div>
                ...
                <div className="code-line text-white ml-2 sm:ml-4">return x + y;</div>
                <div className="code-line text-red-400">{'}'}</div>
                <div className="code-line text-[#00D1FF] mt-1 sm:mt-2 font-bold text-xs sm:text-sm">// 95% Similarity Detected ⚠️</div>
              </div>
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-gray-900 to-transparent h-4 sm:h-6"></div>
              <div className="absolute top-1.5 right-1.5 sm:top-2 sm:right-2 bg-red-500 text-white px-1.5 py-0.5 sm:px-2 sm:py-1 rounded text-xs font-bold animate-pulse">
                PLAGIARISM DETECTED
              </div>
            </div>
          </div>
